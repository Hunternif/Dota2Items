...
//		orbOfVenom
		public static CfgInfo<Dota2Item> ringOfHealth = new CfgInfo<>(27039, "Ring of Health")
...
//		clarity
		public static CfgInfo<Tango> tango = new CfgInfo<>(27002, "Tango")
...
//		bottle
		...
		public static CfgInfo<Dota2Item> ironBranch = new CfgInfo<>(27012, "Iron Branch")
				.setPrice(53).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Iron Branch").setStrength(1).setAgility(1).setIntelligence(1));
		public static CfgInfo<Dota2Item> gauntletsOfStrength = new CfgInfo<>(27013, "Gauntlets of Strength")
				.setPrice(150).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Gauntlets of Strength").setStrength(3));
		public static CfgInfo<Dota2Item> slippersOfAgility = new CfgInfo<>(27014, "Slippers of Agility")
				.setPrice(150).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Slippers of Agility").setAgility(3));
		public static CfgInfo<Dota2Item> mantleOfIntelligence =	new CfgInfo<>(27015, "Mantle of Intelligence")
				.setPrice(150).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Mantle of Intelligence").setIntelligence(3));
		public static CfgInfo<Dota2Item> circlet = new CfgInfo<>(27016, "Circlet")
				.setPrice(185).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Circlet").setStrength(2).setAgility(2).setIntelligence(2));
		public static CfgInfo<Dota2Item> beltOfStrength = new CfgInfo<>(27017, "Belt of Strength")
				.setPrice(450).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Belt of Strength").setStrength(6));
		public static CfgInfo<Dota2Item> bandOfElvenskin = new CfgInfo<>(27018, "Band of Elvenskin")
				.setPrice(450).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Band of Elvenskin").setAgility(6));
		public static CfgInfo<Dota2Item> robeOfTheMagi = new CfgInfo<>(27019, "Robe of the Magi")
				.setPrice(450).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Robe of the Magi").setIntelligence(6));
		public static CfgInfo<Dota2Item> ogreClub = new CfgInfo<>(27020, "Ogre Club")
				.setPrice(1000).setColumn(Column.ATTRIBUTES)
				.setWeaponDamage(7).setPassiveBuff(new Buff("Ogre Club").setStrength(10));
		public static CfgInfo<Dota2Item> bladeOfAlacrity = new CfgInfo<>(27021, "Blade of Alacrity")
				.setPrice(1000).setColumn(Column.ATTRIBUTES)
				.setWeaponDamage(7).setPassiveBuff(new Buff("Blade of Alacrity").setAgility(10));
		public static CfgInfo<Dota2Item> staffOfWizardry = new CfgInfo<>(27010, "Staff of Wizardry")
				.setPrice(1000).setWeaponDamage(2).setColumn(Column.ATTRIBUTES)
				.setPassiveBuff(new Buff("Staff of Wizardry").setIntelligence(10));
		public static CfgInfo<Dota2Item> ultimateOrb = new CfgInfo<>(27022, "Ultimate Orb")
		...
		public static CfgInfo<Dota2Item> ringOfProtection = new CfgInfo<>(27005, "Ring of Protection")
		...
		public static CfgInfo<QuellingBlade> quellingBlade = new CfgInfo<>(27003, "Quelling Blade")
				...
				"[Melee bonus:] {32%}\n[Ranged bonus:] {12%}");
		public static CfgInfo<Dota2Item> stoutShield = new CfgInfo<>(27031, "Stout Shield")
		...
		public static CfgInfo<Dota2Item> bladesOfAttack = new CfgInfo<>(27023, "Blades of Attack")
		...
		public static CfgInfo<Dota2Item> chainmail = new CfgInfo<>(27024, "Chainmail")
				.setPrice(550).setColumn(Column.ARMAMENTS)
				.setPassiveBuff(new Buff("Chainmail").setArmor(5));
		public static CfgInfo<Dota2Item> helmOfIronWill = new CfgInfo<>(27025, "Helm of Iron Will")
				.setPrice(950).setColumn(Column.ARMAMENTS)
				.setPassiveBuff(new Buff("Helm of Iron Will").setArmor(5).setHealthRegen(3));
		public static CfgInfo<Dota2Item> broadsword = new CfgInfo<>(27026, "Broadsword")
				.setPrice(1200).setWeaponDamage(7).setColumn(Column.ARMAMENTS)
				.setPassiveBuff(new Buff("Broadsword").setDamage(18));
		public static CfgInfo<Dota2Item> quarterstaff = new CfgInfo<>(27027, "Quarterstaff")
...
//		morbidMask
//		ghostScepter
		public static CfgInfo<Dota2Item> talismanOfEvasion = new CfgInfo<>(27035, "Talisman of Evasion")
...
//		shadowAmulet
		...
		// Item column: Common ========================================================================
		public static CfgInfo<Dota2Item> wraithBand = new CfgInfo<>(27036, "Wraith Band")
		...
		public static CfgInfo<Dota2Item> nullTalisman = new CfgInfo<>(27037, "Null Talisman")
...
//		magicWand
		public static CfgInfo<Dota2Item> bracer = new CfgInfo<>(27038, "Bracer")
...
//		phaseBoots
//		powerTreads
		public static CfgInfo<Dota2Item> oblivionStaff = new CfgInfo<>(27051, "Oblivion Staff")
		...
		public static CfgInfo<Dota2Item> perseverance = new CfgInfo<>(27050, "Perseverance")
...
//		monkeyKingBar
//		daedalus
		public static CfgInfo<Dota2Item> butterfly = new CfgInfo<>(27053, "Butterfly")
		...
		public static CfgInfo<Dota2Item> divineRapier = new CfgInfo<>(27054, "Divine Rapier")
...
//		hoodOfDefiance
//		bladeMail
		public static CfgInfo<Dota2Item> vanguard = new CfgInfo<>(27052, "Vanguard")
				...
				.setDescription("Passive: Damage Block - Gives a chance to block damage, depending on the type of hero you are.");
		public static CfgInfo<Dota2Item> soulBooster = new CfgInfo<>(27049, "Soul Booster")
