        ...
        if(Block.blocksList[b_id] != null || b_id == 0){
            ...
            if (storageArray == null) {
                ...
                if (storageArrays[(worldVector.getY() >> 4) - 1] == null) {
                	System.out.println(" ## [QUEST]: Schematic import is about to throw NPE @ storageArrays when pasting block at (" + x + "," + y + "," + z + ")!");
                	System.out.println(" ##   The schematic has dimensions: (" + file.getWidth() + "," + file.getHeight() + "," + file.getLength() + ")");
                	System.out.println(" ##   This is a bug, if you are running the latest version then contact Mazetar (PM/IRC/Forum thread) and give him the log and schematic files!");
